...
const navigationValues = [
  ...
  {
    name: 'Issues', value: 232, selected: true, url: `${window.location.origin}`,
  },
  {
    name: 'Pull Requests', value: 43, selected: false, url: `${WEB_URL}/${OWNER}/${REPO}/pulls`,
  },
  {
    name: 'Projects', value: 1, selected: false, url: `${WEB_URL}/${OWNER}/${REPO}/projects`,
  },
  {
